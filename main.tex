...
\usepackage[backend=bibtex,style=authoryear,natbib=true,superscript,biblabel]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\thesistitle{*3YP Title Here*} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\include{Chapters/ChapterTutorial}
