...
\begin{figure}[ht]
\centering
\includegraphics[scale = 0.60]{overview11.png}
...
and a percentage meter to indicate the degree of the features. Therefore the post-feature metrix will intensively rely on our users and it can suffer from high variance of subjectiveness.
...
\\Before we dive into algorithm, we first need to construct the user-post interaction matrix.
\begin{table}[ht]
\centering
\begin{tabular}{ |c|c|c|c|c|c|} 
 \hline
