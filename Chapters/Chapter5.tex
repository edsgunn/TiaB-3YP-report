...
\begin{equation}
    |\hat{X}(\omega,k)| = \begin{cases}
        |\hat{X}(\omega,k)|   & \text{if \hat{X}(\omega,k) \leq 0}\\
        0                     & \text{otherwise.}
    \end{cases}
\end{equation}
...
To target the weakness, we can introduce another mechanism so that when the estimated 
