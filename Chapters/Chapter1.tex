...
The MVP is further detailed in \cref{UImvp} and \cref{sec:MVPRequirements}
...
The design for the software to implement each part of the project is heavily modularised, in keeping with the philosophy of object-oriented programming \textbf{HOW?}.
...
The project was conducted with an agile approach. \textbf{WHY?}
