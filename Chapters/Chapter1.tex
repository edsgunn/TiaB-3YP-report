...
\multicolumn{1}{|c}{\textbf{Direct Cost}} &\multicolumn{1}{c}{}&\\
 ...
 \hline
 \textbf{Total}&\multicolumn{1}{c}{$17.3\%\times N \times P + \pounds 354,396$}&\\
 \hline
 \end{tabular}
...
\footfullcite{framework} that are minimum standards for handling data ethically. The core value of data ethics 
...
deal with inappropriate material posted online.\footfullcite{francis} \footfullcite{parliamentlaw} Companies have the responsibility to confine illegal and harmful discussions, and a conventional and efficient method
...
for science and innovation that are socially desirable and undertaken in the public interest.\footfullcite{ukri} Not only does research bring novelty 
...
Also, according to research done by \cite{cloudpercent}, we can reduce energy consumption by 87\% by employing a cloud architecture.
...
their businesses to optimise server usage. Thus sharing cloud servers can increase average server utilisation to 50 per cent or higher \footfullcite{cloud}.
