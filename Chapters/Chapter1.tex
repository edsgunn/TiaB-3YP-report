...
\\ \textbf{Advertisament}
\\ We decides to cooperate with other music-related companies and place their advertisements in our app pages, the revenue will be based on the number of clicks. We will use A/B Testing to decide the place and methods how we will place the advertisement and minimising the influence to user experience.
\\ \textbf{Subscription}
...
Yet, researches have shown that cloud computing is more energy efficient than relying on local devices (i.e. using our private data centers, computing on
...
their busienss to optimise server usage. Thus sharing cloud servers can increase average server utilization to 50 percent or higher \footfullcite{cloud}.
