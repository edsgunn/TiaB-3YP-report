...
Also, we can reduce energy consumption by 87\% by employing a cloud architecture
...
As mentioned in section (\textbf{link to tech section above!}), current smartphones have built-in machine learning capabilities so we can consider applying 
our machine learning models locally (i.e. on the users' devices) as to reduce the energy usage.
