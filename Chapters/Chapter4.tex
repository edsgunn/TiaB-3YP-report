...
\paragraph{Quantitative Evalutaion}
...
By modeling the $\boldsymbol{X}$ and $\boldsymbol{Y}$ Markov Processes %\textbf{references?} 
...
The standard tool to find the gradients is the backpropagation alogrithm %\textbf{REFERENCE BACKPROP} 
