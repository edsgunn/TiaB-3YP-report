...
\paragraph{Chord Generation from Symbolic Melody - 6} This was the main model under scrutiny in \cite{BLSTM} mentioned above in \cref{subsec:HMM} and \cref{subsec:DNN-HMMs}.
