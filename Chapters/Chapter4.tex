...
We defined criteria for evaluation against these requirements and applied this to a number of models implemented in other papers.
Using the lessons we learned from this evaluation 
\textbf{BE MORE CLEAR ABOUT THE LESSONS WE LEARNED IN THE MAIN SECTION} 
we proposed the use of an LSTMGAN as a solution to this problem and detailed how this should be structured, implemented, trained and tested.
We also outlined functionality and results from our preliminary implementation.